...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Home = function (_Component) {\n  _inherits(Home, _Component);\n\n  function Home() {\n    _classCallCheck(this, Home);\n\n    return _possibleConstructorReturn(this, (Home.__proto__ || Object.getPrototypeOf(Home)).apply(this, arguments));\n  }\n\n  _createClass(Home, [{\n    key: 'render',\n    value: function render() {\n      return _react2.default.createElement(\n        'div',\n        null,\n        _react2.default.createElement(\n          'h3',\n          null,\n          ' Home page '\n        ),\n        _react2.default.createElement(\n          'p',\n          null,\n          ' Built in ssr React and Redux '\n        )\n      );\n    }\n  }]);\n\n  return Home;\n}(_react.Component);\n\n;\n\nexports.default = {\n  component: Home\n};\n\n//# sourceURL=webpack:///./src/client/js/pages/HomePage.js?");

/***/ }),

/***/ "./src/client/js/pages/NotFoundPage.js":
/*!*********************************************!*\
  !*** ./src/client/js/pages/NotFoundPage.js ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar NotFoundPage = function NotFoundPage(_ref) {\n\tvar _ref$staticContext = _ref.staticContext,\n\t    staticContext = _ref$staticContext === undefined ? {} : _ref$staticContext;\n\n\tstaticContext.notFound = true;\n\treturn _react2.default.createElement(\n\t\t'h1',\n\t\tnull,\n\t\t'Oops, page not found.'\n\t);\n};\n\nexports.default = {\n\tcomponent: NotFoundPage\n};\n\n//# sourceURL=webpack:///./src/client/js/pages/NotFoundPage.js?");

/***/ }),

/***/ "./src/client/js/pages/UsersListPage.js":
/*!**********************************************!*\
  !*** ./src/client/js/pages/UsersListPage.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _actions = __webpack_require__(/*! ../actions */ \"./src/client/js/actions/index.js\");\n\nexports.default = function () {\n\tvar state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n\tvar action = arguments[1];\n\n\tswitch (action.type) {\n\t\tcase _actions.FETCH_ADMINS:\n\t\t\treturn action.payload.data;\n\t\tdefault:\n\t\t\treturn state;\n\t}\n};\n\n//# sourceURL=webpack:///./src/client/js/reducers/adminsReducer.js?");

/***/ }),

/***/ "./src/client/js/reducers/authReducer.js":
/*!***********************************************!*\
  !*** ./src/client/js/reducers/authReducer.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _redux = __webpack_require__(/*! redux */ \"redux\");\n\nvar _usersReducer = __webpack_require__(/*! ./usersReducer */ \"./src/client/js/reducers/usersReducer.js\");\n\nvar _usersReducer2 = _interopRequireDefault(_usersReducer);\n\nvar _authReducer = __webpack_require__(/*! ./authReducer */ \"./src/client/js/reducers/authReducer.js\");\n\nvar _authReducer2 = _interopRequireDefault(_authReducer);\n\nvar _adminsReducer = __webpack_require__(/*! ./adminsReducer */ \"./src/client/js/reducers/adminsReducer.js\");\n\nvar _adminsReducer2 = _interopRequireDefault(_adminsReducer);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// combine all existing reducers\nexports.default = (0, _redux.combineReducers)({\n\tusers: _usersReducer2.default,\n\tauth: _authReducer2.default,\n\tadmins: _adminsReducer2.default\n});\n// import usersReducer\n\n//# sourceURL=webpack:///./src/client/js/reducers/index.js?");

/***/ }),

/***/ "./src/client/js/reducers/usersReducer.js":
/*!************************************************!*\
  !*** ./src/client/js/reducers/usersReducer.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _actions = __webpack_require__(/*! ../actions */ \"./src/client/js/actions/index.js\");\n\n// export a reducer with state with list of users and FETCH_USERS action \nexports.default = function () {\n\tvar state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n\tvar action = arguments[1];\n\n\t// if actions.type\n\tswitch (action.type) {\n\t\t//if actions.type is FETCH_USERS\n\t\tcase _actions.FETCH_USERS:\n\t\t\t// if action has data attached to it, then store the data\n\t\t\treturn action.payload.data;\n\t\tdefault:\n\t\t\t// else return state\n\t\t\treturn state;\n\t}\n}; // import fetch users action\n\n//# sourceURL=webpack:///./src/client/js/reducers/usersReducer.js?");

/***/ }),

/***/ "./src/client/js/routes/Routes.js":
/*!****************************************!*\
  !*** ./src/client/js/routes/Routes.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _App = __webpack_require__(/*! ./../App */ \"./src/client/js/App.js\");\n\nvar _App2 = _interopRequireDefault(_App);\n\nvar _HomePage = __webpack_require__(/*! ./../pages/HomePage */ \"./src/client/js/pages/HomePage.js\");\n\nvar _HomePage2 = _interopRequireDefault(_HomePage);\n\nvar _UsersListPage = __webpack_require__(/*! ./../pages/UsersListPage */ \"./src/client/js/pages/UsersListPage.js\");\n\nvar _UsersListPage2 = _interopRequireDefault(_UsersListPage);\n\nvar _NotFoundPage = __webpack_require__(/*! ./../pages/NotFoundPage */ \"./src/client/js/pages/NotFoundPage.js\");\n\nvar _NotFoundPage2 = _interopRequireDefault(_NotFoundPage);\n\nvar _AdminsListPage = __webpack_require__(/*! ./../pages/AdminsListPage */ \"./src/client/js/pages/AdminsListPage.js\");\n\nvar _AdminsListPage2 = _interopRequireDefault(_AdminsListPage);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = [_extends({}, _App2.default, {\n\troutes: [_extends({}, _HomePage2.default, {\n\t\tpath: '/',\n\t\texact: true\n\t}), _extends({}, _AdminsListPage2.default, {\n\t\tpath: '/admins'\n\t}), _extends({}, _UsersListPage2.default, {\n\t\tpath: '/users'\n\t}), _extends({}, _NotFoundPage2.default)]\n})];\n\n//# sourceURL=webpack:///./src/client/js/routes/Routes.js?");
